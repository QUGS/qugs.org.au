...
if ($q) // if query created
{
	...
	try
	{
		$resp = (array) $client->lists->setListMember("faba794f30", md5(strtolower($_POST['email'])), [
			...
			"merge_fields"		=>	array('FNAME' => $_POST['fname'],
										  'LNAME' => $_POST['lname']),
			"interests"     	=> 	array('2d88eac20f'  => true) //change annually //update yearly
		]);
	}
	...
	mail($_POST['email'], "Welcome To QUGS",
		 "<html>\n"
			 ...
			 . "<body>\n"
			 . "<div>\n"
			 . "<h1>Thank you for joining the Queensland University Games Society for 2026.</h1>\n" //change annually //update yearly
			 ...
			 . "<table>\n"
			 . "<tr><td>QUGS Membership, 2026<br/>&emsp;&emsp;" . $_POST['fname'] . " " . $_POST['lname'] . "</td><td>$5.00</td></tr>\n" //change annually //update yearly
			 ...
			 . "</table>\n"
			 . "<p style=\"margin-bottom: 0.4em;\">Thank you for being a member of QUGS in 2026, and we look forward to seeing you at our events</p>\n" //change annually //update yearly
			 . "<p style=\"margin-top: 0.4em;\">Harry (President) and the rest of the QUGS 2026 Committee</p>\n" //change annually //update yearly
    ...
    echo "<style>@font-face{font-family: helv;src: url(Helv.otf);}"
          ...
          . "    else"
          . "    {"
          . "        document.getElementById('redirect').innerHTML = 'Returning to the membership form in ' + n + ' second' + (n == 1 ? '' : 's') + '.';"
          . "    }"
          . "}, 1000);</script></html>";
    exit();
